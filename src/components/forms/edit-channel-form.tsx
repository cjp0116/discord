...
export function EditChannelForm({ channelId, initialData, serverName }: EditChannelFormProps) {
    ...
    <FadeIn className="w-full max-w-md">
      <Card className="animate-in slide-in-from-bottom-4 duration-500">
        <CardHeader>
          ...
          <CardDescription>
            Update details for {initialData.name} in {serverName}.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form action={action} className="space-y-4">
            ...
            <FadeIn delay={300}>
              <FormField error={state?.errors?.type?.[0]}>
                ...
                <RadioGroup defaultValue={initialData.type} name="type" className="flex space-x-4 mt-2">
            ...
            <FadeIn delay={400}>
              <Button type="submit" className="w-full" loading={isPending} loadingText="Saving changes...">
                Save Changes
              </Button>
            </FadeIn>
